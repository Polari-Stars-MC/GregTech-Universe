...
/**
 * Direct data-flow port of Cosmic Horizons' InitialiseRenderSequenceProcedure.
 */
public final class InitialiseRenderSequenceProcedure {
    private InitialiseRenderSequenceProcedure() {
    }

    public static CosmicEarthRenderData execute(Vector3f lightLocal, Vector3f viewLocal) {
        ...
        for (Direction direction : Direction.values()) {
            ...
            Vector3f vertex1 = CubeVertexOrientorProcedure.execute(direction, 0.0, new Vector3f(-0.5F, 0.5F, -0.5F));
            Vector3f vertex2 = CubeVertexOrientorProcedure.execute(direction, 0.0, new Vector3f(-0.5F, 0.5F, 0.5F));
            Vector3f vertex3 = CubeVertexOrientorProcedure.execute(direction, 0.0, new Vector3f(0.5F, 0.5F, 0.5F));
            Vector3f vertex4 = CubeVertexOrientorProcedure.execute(direction, 0.0, new Vector3f(0.5F, 0.5F, -0.5F));
