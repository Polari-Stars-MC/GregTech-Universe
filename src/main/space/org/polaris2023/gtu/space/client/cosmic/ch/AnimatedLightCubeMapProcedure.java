...
/**
 * Direct data port of Cosmic Horizons' AnimatedLightCubeMapProcedure.
 */
public final class AnimatedLightCubeMapProcedure {
    private AnimatedLightCubeMapProcedure() {
    }
